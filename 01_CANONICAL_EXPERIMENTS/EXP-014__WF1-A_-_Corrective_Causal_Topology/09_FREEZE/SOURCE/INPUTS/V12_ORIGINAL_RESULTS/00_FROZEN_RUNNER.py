...
EXPERIMENT = "V12_RELATIONAL_TOPOLOGY_CAUSAL_MAP_JSON_R4"
MODEL = "gpt-5.6-luna"
MASTER_SEED = 120918
...
def self_test():
    ...
    tmp = ROOT/"_V12_FINAL_SELFTEST_TMP"
...
def main():
    ...
    if args.preflight_only:
        print(
            "V12 FINAL zero-cost preflight starting...",
            flush=True
        )
    ...
    if args.self_test:
        print(
            "V12 FINAL full downstream analysis self-test...",
            flush=True
        )
